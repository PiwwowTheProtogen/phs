...
local function copewithdeath(ply)
    ...
    if deduction > 0 then
        ...
        Nexus:ChatMessage(player, {Color(255,148,191), "[PHI]", Color_White, "The hospital decided to treat your injuries pro-bono."})
    end
...
if PHS.Settings.TimeRemoval and PHS.Settings.TimeRemoval > 0 then
    timer.Create("InsuranceTimer", PHS.Settings.TimeRemoval * 60, 0, function()
